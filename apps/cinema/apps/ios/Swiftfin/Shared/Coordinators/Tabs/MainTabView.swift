...
struct MainTabView: View {
    ...
    private func tabContent() -> some View {
        ...
        #else
        // Cinema: the web app's left rail, natively. iPadOS turns
        // `.sidebarAdaptable` into a rail it can expand; iPhone keeps the tab
        // row, which is the only right answer there.
        if UIDevice.isPad {
            tabView()
                .tabViewStyle(.sidebarAdaptable)
        } else {
