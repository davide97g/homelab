...
internal enum L10n {
  ...
  /// The custom device profiles will be added to the default Cinema device profiles.
  internal static let customDeviceProfileAdd = L10n.tr("Localizable", "customDeviceProfileAdd", fallback: "The custom device profiles will be added to the default Cinema device profiles.")
  /// The custom device profiles will replace the default Cinema device profiles.
  internal static let customDeviceProfileReplace = L10n.tr("Localizable", "customDeviceProfileReplace", fallback: "The custom device profiles will replace the default Cinema device profiles.")
  ...
  /// Changes the Jellyfin server user password. This does not change any Cinema settings.
  internal static let passwordChangeWarning = L10n.tr("Localizable", "passwordChangeWarning", fallback: "Changes the Jellyfin server user password. This does not change any Cinema settings.")
  ...
  /// Manage additional Cinema settings in the Settings app.
  internal static let permissionsSettingsAppFooter = L10n.tr("Localizable", "permissionsSettingsAppFooter", fallback: "Manage additional Cinema settings in the Settings app.")
  /// Person
  ...
  /// Reset Cinema user settings.
  internal static let resetSettingsDescription = L10n.tr("Localizable", "resetSettingsDescription", fallback: "Reset Cinema user settings.")
  ...
  /// Cinema requires Jellyfin version %@ or higher.
  internal static func serverVersionWarning(_ p1: Any) -> String {
    return L10n.tr("Localizable", "serverVersionWarning", String(describing: p1), fallback: "Cinema requires Jellyfin version %@ or higher.")
  }
  /// Session
  ...
  /// Signs out the last user when Cinema has been in the background without media playback after some time.
  internal static let signoutBackgroundFooter = L10n.tr("Localizable", "signoutBackgroundFooter", fallback: "Signs out the last user when Cinema has been in the background without media playback after some time.")
  /// Sign out on close
  internal static let signoutClose = L10n.tr("Localizable", "signoutClose", fallback: "Sign out on close")
  /// Signs out the last user when Cinema has been force closed.
  internal static let signoutCloseFooter = L10n.tr("Localizable", "signoutCloseFooter", fallback: "Signs out the last user when Cinema has been force closed.")
  /// Simple
