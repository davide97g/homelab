...
struct AppSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            // Cinema drops upstream's Customize section here: every alternate
            // app icon in it is Jellyfin's, and the appearance picker is dead
            // UI now that Reel forces dark.
