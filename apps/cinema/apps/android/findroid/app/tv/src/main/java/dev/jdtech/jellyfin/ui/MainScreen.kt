            ...
            TabRow(
                ...
                indicator = { tabPositions, isActivated ->
                    ...
                    PillBorderIndicator(
                        ...
                        activeBorderColor = CinemaColors.foreground,
                        inactiveBorderColor = Color.Transparent,
                        doesTabRowHaveFocus = isActivated,
                    )

                    // SelectedTab's indicator. Cinema: red, because the active
                    // navigation marker is one of the three things the action
                    // colour is for. It was white, and upstream paired it with
                    // colorScheme.onPrimary -- which under Reel is also white,
                    // so the selected tab's label disappeared.
                    TabRowDefaults.PillIndicator(
                        currentTabPosition = tabPositions[activeTabIndex],
                        activeColor = CinemaColors.primary,
                        inactiveColor = CinemaColors.primary,
                        doesTabRowHaveFocus = isActivated,
                    )
                },
