...
fun NavigationRoot(
    ...
    // Cinema: the active navigation marker is red, which is one of the three
    // things the action colour is for. The default draws it from
    // secondaryContainer, and under Reel every container role is neutral on
    // purpose. Hoisted out of navigationSuiteItems, which is not composable.
    val cinemaNavigationItemColors =
        NavigationSuiteDefaults.itemColors(
            navigationBarItemColors =
                NavigationBarItemDefaults.colors(
                    indicatorColor = CinemaColors.primary,
                    selectedIconColor = CinemaColors.onPrimary,
                    selectedTextColor = CinemaColors.foreground,
                    unselectedIconColor = CinemaColors.mutedForeground,
                    unselectedTextColor = CinemaColors.mutedForeground,
                ),
        ...
        navigationSuiteItems = {
            navigationItems.forEach { item ->
                item(
                    ...
                    colors = cinemaNavigationItemColors,
                )
            }
        },
